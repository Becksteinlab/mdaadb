...
The MDAnalysis Analysis Database *Code of Conduct* sets the rules for the behavior of
every member in the MDAnalysis Analysis Database community so that everyone can
...
MDAnalysis Analysis Database is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make MDAnalysis Analysis Database a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and MDAnalysis Analysis Database is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of MDAnalysis Analysis Database comes from its varied community
...
reported by contacting the project team at 'ejakupov@asu.edu'. The project team will
...
modified by MDAnalysis Analysis Database.
