...
project = "MDAnalysis Analysis Database"
copyright = (
    "2024, Edis Jakupovic. "
...
htmlhelp_basename = "mdaadb-kitdoc"
...
latex_documents = [
    (master_doc, "mdaadb-kit.tex", "MDAnalysis Analysis Database Documentation",
     "mdaadb-kit", "manual"),
]
...
man_pages = [
    (master_doc, "mdaadb-kit", "MDAnalysis Analysis Database Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "mdaadb-kit", "MDAnalysis Analysis Database Documentation",
     author, "mdaadb-kit", "A short description of the project.",
     "Miscellaneous"),
]
