...
We welcome all contributions to MDAnalysis Analysis Database!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/BecksteinLab/mdaadb-kit/issues)
...
The second two options both involve making a [pull request](https://github.com/BecksteinLab/mdaadb-kit/pulls) .
